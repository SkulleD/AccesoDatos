...
public class JDBC_ejers {
    ...
    public void ej4(String nombre, String pais, String fabricante, String lanzamiento) {
        String query = "insert into naves (nombre, pais, fabricante, SistemaLanzamiento)\n" + "values ('" + nombre
    ...
    public static void main(String[] args) {
        ...
        jdbc.ej4("Nueghgfhombre", "Nuevthrrth país", "Nuevohrtht fabricante", "Nuevo thLANZAMIENTO");
        jdbc.cierraConexion();
    }
}